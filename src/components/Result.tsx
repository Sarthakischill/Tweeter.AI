        ...
        <section className={`flex flex-col gap-2 w-[60vw] max-sm:w-full bg-transparent border-none shadow-none mt-6 py-3 ${result ? 'block' : 'hidden'}`}>
            <div className="flex justify-end gap-2 relative">
                ...
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <div>
                                <ShinyButton asDiv onClick={handleRegenerate} className="p-2 max-sm:p-2">
                ...
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger asChild>
                            <div onClick={saveInteraction} className="bg-transparent rounded-lg before:bg-opacity-5 backdrop-blur-lg border border-gray-400/50 dark:border-white/20 dark:text-white p-2 max-sm:p-1 max-sm:px-1.5 hover:bg-white/10 transition-all duration-300 cursor-pointer">
                ...
                <TooltipProvider>
                    <Tooltip>
                        <Link href={`https://twitter.com/intent/tweet?text=${result}`} target="_blank">
                            <TooltipTrigger asChild>
                                <div className="bg-transparent rounded-lg before:bg-opacity-5 backdrop-blur-lg border border-gray-400/50 dark:border-white/20 dark:text-white p-2 max-sm:p-1 max-sm:px-1.5 hover:bg-white/10 transition-all duration-300 cursor-pointer">
